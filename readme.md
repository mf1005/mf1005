...
本ツール「AnonConnect」の核心は、社員の匿名性を守りつつ、役員との双方向スレッド対話を実現した **「状態管理設計」** にあります。
...
**ペライチ資料（匿名対話の概念図）**
**提示したコアバリュー:** 複雑なシステムを組まずとも、「アプリがSlackのスレッドを仲介するだけで、お互いの送信元がアプリに置き換わり、匿名対話が成立する」という本質を可視化。
**5分での即決:** 役員が懸念していた「本当に匿名性は守られるのか？」という問いに対し、この図一枚で「技術的根拠」と「運用の簡便さ」を証明。その場でGOサインを勝ち取りました。
**成果:** その後3日でプロトタイプをデプロイ。この「スピード感」こそが、私が考える組織の不確実性を舗装するエンジニアリングのあり方です。

<img width="1147" height="396" alt="image" src="https://github.com/user-attachments/assets/b5a970cc-cd65-49d7-a831-b290aea2467c" />
