...
当時のアプリ容量制限はわずか**10KB**。複数メーカーのプロトコルを実装しつつ、1バイトを削り出すために「構造化よりもリソース最適化」を優先する極限のプログラミングを経験しました。
この **「1バイトの重み」を知る経験** や、**「現場で現物を解析し、マルチベンダーの差異を吸収する執念」** が、現在の私のエンジニアリングスタイルの根底に流れています。
